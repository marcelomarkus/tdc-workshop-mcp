"""Servidor MCP principal do workshop.

Este módulo reúne exemplos de autenticação com Auth0, resources, tools e
prompts. Também demonstra confirmação explícita e acompanhamento de progresso
